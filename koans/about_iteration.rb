...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Describe in your own words what inject does.
		#
		# Inject starts with a value, performs the block operation on that value
		# with th first element in the list, stores the resulting value, and repeats with the new
		# value on the next value in the list... etc... etc...
  end
  ...
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
	...
	# Bonus Answer:
	#
	# Because by doing it this way we can ensure that the life of the file is properly
	# ended at the end of the execution of our file code. It's also semantically pretty
	# in that it is clear where the file is used, and where it is not.
